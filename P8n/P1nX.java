...
public class P1nX
{
  ...
  public double calcula(double r)	// metodo de classe de calculo da area do circulo
  {
  ...
  public static double calcula(double b, double a)	// metodo de classe de calculo da area do retangulo
  {
  ...
  public static double calcula(double l1, double l2, double l3)    // metodo de classe de calculo da area do triangulo
  {
    double s, area = 0;
    int ok;
  ...
  public static void classifica(double l1, double l2, double l3)   // metodo de classe de classificacao do triangulo
  {
	int ok;
